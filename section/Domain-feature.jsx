...
const Doamainfeature = () => {
  return (
      <div className="container">
                <div className="row">
                    <div className="col-lg-6 offset-lg-3 text-center">
                        <h5 className="s2">Domain Features</h5>
                        <h2>Unleash maximum potential of your <span className="id-color">domain</span></h2>
